...
// -----Device Name -----
const char* deviceName = "ConferenceRoom";  // Unique identifier for Firebase
...
#define RZERO135 75882.0 // Recalibrated for ~400 ppm CO₂
#define RZERO9 20650.0    // Recalibrated for ~1 ppm CO, ~2ppm CH₄
...
void readSensors(){
  ...
  if(mq135_voltage > 0.1){
    ...
    float ratio135 = rs135/ RZERO135;     // RZERO135 calibrated for ~400 ppm
     co2_ppm = 110.48 *pow(ratio135, -2.769034857);
  ...
  if (mq9_voltage > 0.1) 
  {
    ...
    co_ppm = 0.114 * pow(ratio9, -1.2);
    ch4_ppm =0.076 *pow(ratio9, -1.5);
  }
